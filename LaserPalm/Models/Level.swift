...
enum AnimalType: String, Codable {
    ...
    var size: Float {
        ...
        case .sparrow, .robin, .finch:
            return 0.4  // Increased for easier hitting (was 0.2)
        case .parrot, .toucan, .macaw:
            return 0.5  // Increased (was 0.25)
        case .wolf, .fox, .lynx:
            return 0.6  // Increased (was 0.3)
        case .lion, .tiger, .bear:
            return 0.7  // Increased (was 0.35)
        case .eagle, .hawk, .falcon:
            return 0.6  // Increased (was 0.4)
        }
    }
